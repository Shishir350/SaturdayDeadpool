...
public class Loops {
	...
	/* 	
 	Type of Loops
  		1. For Loop  -    uper case
  		2. While Loop   - condition
  		3. Do While Loop  - do firt then check the condition
  		4. Infinite Loop   -
  		5. Nested loop - one lope inside antother
 */
	...
	public static void practiceForLoop(){						//For Loop - Do again and again upto upper limit
		...
		for (i = 1; i<=1;i++){									//Setting lower limit, Upper limit, Increment or Decrement
